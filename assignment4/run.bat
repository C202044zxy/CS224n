...
if "%1%"=="train" (
    ...
    set CUDA_VISIBLE_DEVICES=0 & C:/Users/16549/AppData/Local/Programs/Python/Python311/python.exe run.py decode model.bin ./zh_en_data/test.zh ./zh_en_data/test.en outputs/test_outputs.txt --cuda
