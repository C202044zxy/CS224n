...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # nn.Parameter is a class representing a parameter tensor that is a learnable parameter
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.index_select(self.embeddings, 0, w.reshape(-1)).reshape(w.shape[0], -1)
